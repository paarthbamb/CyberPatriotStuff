...
echo [ [96mINFO[0m ] Setting MINPWLENGTH to 14 characters...
...
echo [ [96mINFO[0m ] Setting lockout threshold to 5 attempts...
...
echo [ [96mINFO[0m ] Setting lockout window to 30 minutes...
net accounts /lockoutwindow:30 >nul
if ERRORLEVEL 1 (
...
echo [ [96mINFO[0m ] Changing all user passwords except self to 'CyberPatriot14'...
setlocal
for /f "delims=" %%u in ('cscript //NoLogo %~dp0\bundle\GetLocalUsers.vbs') do (
  net user "%%u" "CyberPatriot14"
)
if ERRORLEVEL 1 (
